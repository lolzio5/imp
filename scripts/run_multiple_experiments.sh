...
COMMANDS=(
    ...
    # # ============================================
    # "table4:::python run_eval.py --dataset omniglot --model imp --label-ratio 0.4 --mode-ratio 1.0 --nclasses-train 5 --nclasses-episode 5 --nclasses-eval 5 --nshot 1 --num-test 5 --super-classes --nsuperclassestrain 10 --nsuperclasseseval 10 --disable-distractor --num-unlabel 0 --num-unlabel-test 0 --results $PWD/results/table4/train_seed_{seed} && TRAIN_DIR=$(ls -td $PWD/results/table4/train_seed_{seed}/*/ | head -1) && python run_eval.py --dataset omniglot --model imp --label-ratio 0.4 --mode-ratio 1.0 --nclasses-train 5 --nclasses-episode 5 --nclasses-eval 5 --nshot 1 --num-test 5 --super-classes --nsuperclassestrain 10 --nsuperclasseseval 10 --disable-distractor --use-test --num-unlabel-test 0 --eval --pretrain ${TRAIN_DIR}modelbest.pt --results $PWD/results/table4/test_seed_{seed}"
