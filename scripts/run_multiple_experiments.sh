...
COMMANDS=(
    ...
    "table3_alphabet_chars_train:::python run_eval.py --dataset omniglot --model imp --mode-ratio 1.0 --label-ratio 1.0 --nclasses-train 10 --nclasses-episode 10 --nclasses-eval 10 --nshot 1 --num-test 5 --super-classes --nsuperclassestrain 10 --nsuperclasseseval 10 --disable-distractor --num-unlabel 0 --num-unlabel-test 0 --results ./results/table3/alphabet_chars_train"
    "table3_alphabet_chars_test:::python run_eval.py --dataset omniglot --model imp --mode-ratio 1.0 --label-ratio 1.0 --nclasses-train 20 --nclasses-episode 20 --nclasses-eval 20 --nshot 1 --num-test 5 --disable-distractor --use-test --num-unlabel-test 0 --eval --pretrain ./results/table3/alphabet_chars_train/best --results ./results/table3/alphabet_chars_test"
    ...
    # ============================================
    "table4_train:::python run_eval.py --dataset omniglot --model imp --label-ratio 1.0 --mode-ratio 0.4 --nclasses-train 5 --nclasses-episode 5 --nclasses-eval 5 --nshot 1 --num-test 5 --super-classes --nsuperclassestrain 10 --nsuperclasseseval 10 --disable-distractor --num-unlabel 0 --num-unlabel-test 0 --results ./results/table4/train"
    "table4_test:::python run_eval.py --dataset omniglot --model imp --label-ratio 1.0 --mode-ratio 0.4 --nclasses-train 5 --nclasses-episode 5 --nclasses-eval 5 --nshot 1 --num-test 5 --super-classes --nsuperclassestrain 10 --nsuperclasseseval 10 --disable-distractor --use-test --num-unlabel-test 0 --eval --pretrain ./results/table4/train/best --results ./results/table4/test"
